...
namespace g0at
{
    namespace model
    {
        object_function_dll::object_function_dll(object_pool *_pool, object_dynamic_library *_library, void *_function_ptr)
            : object_function(_pool), library(_library), function_ptr(_function_ptr)
        {
            lock();
        }
        ...
        {
            void (*fn)() = (void (*)(void))function_ptr;
            fn();
            thr->push_undefined();
        }
    };
