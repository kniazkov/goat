...
namespace g0at
{
    namespace codegen
    {
        ...
        {
        public:
            generator(model::name_cache *_name_cache, bool _debug);
            static lib::pointer<code::code> generate(model::name_cache *name_cache, lib::pointer<pt::function> node_root, bool debug);
            void add_frame(pt::node *node);
