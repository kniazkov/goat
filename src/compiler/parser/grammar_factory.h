...
namespace g0at
{
    namespace parser
    {
        ...
        protected:
            ...
            lib::pointer<pattern> create_pattern_variable_in();
            lib::pointer<pattern> create_pattern_index_access();
            ...
            lib::pointer<pattern> create_pattern_statement_switch();
            ...
            lib::pointer<pattern> create_pattern_method_lock();
